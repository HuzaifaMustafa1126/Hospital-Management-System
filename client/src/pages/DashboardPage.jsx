...
export function DashboardPage() {
  ...
  return <><h2 className="text-2xl font-bold">{admin ? 'Administration dashboard' : 'Reception dashboard'}</h2>
    ...
    </div> : <div className="mt-6 rounded-xl border border-dashed border-sky-300 bg-sky-50 p-6"><h3 className="font-semibold">Patient Registration</h3><p className="mt-2 text-sm text-slate-600">Registration is intentionally unavailable until the next phase.</p></div>}
  </>;
}
