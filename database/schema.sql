...
CREATE TABLE IF NOT EXISTS registration_payments (
  ...
  amount DECIMAL(10,2) NOT NULL, fee_type ENUM('FREE','DISCOUNTED') NOT NULL DEFAULT 'DISCOUNTED', payment_method ENUM('CASH','CARD','BANK_TRANSFER','OTHER') NOT NULL,
...
CREATE TABLE IF NOT EXISTS patient_services (
  ...
  quantity INT UNSIGNED NOT NULL, unit_price DECIMAL(10,2) NOT NULL, total_amount DECIMAL(12,2) NOT NULL, notes VARCHAR(1000) NULL,
  status ENUM('ADDED','IN_PROGRESS','COMPLETED','CANCELLED') NOT NULL DEFAULT 'ADDED', added_by VARCHAR(191) NOT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  KEY idx_patient_services_patient_created (patient_id, created_at), KEY idx_patient_services_service (service_id),
